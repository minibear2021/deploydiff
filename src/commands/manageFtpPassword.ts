...
export function registerSetFtpPasswordCommand(context: vscode.ExtensionContext): vscode.Disposable {
...
export function registerClearFtpPasswordCommand(context: vscode.ExtensionContext): vscode.Disposable {
